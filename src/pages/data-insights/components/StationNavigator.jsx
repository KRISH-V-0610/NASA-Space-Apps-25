...
const stations = [
  {
    id: 'terra25/data-insights/wildfire',
    name: 'Wildfire',
    icon: Flame,
    color: '#FF6B35',
    tagline: 'Real-time fire detection & monitoring',
    description: 'AI-powered thermal sensors detect and track wildfires worldwide, helping predict their spread and support quick response.',
  ...
  {
    id: 'terra25/data-insights/ndvi',
    name: 'Deforestation',
    icon: Leaf,
    color: '#4CAF50',
    tagline: 'Vegetation health analysis',
    description: 'Satellite imaging and data analysis monitor forest loss, revealing patterns of deforestation and helping protect vital ecosystems.',
  ...
  {
    id: 'terra25/data-insights/aster',
    name: 'Surface Temp',
    icon: Mountain,
    color: '#D4A574',
    tagline: 'Terrain & surface temperature',
    description: 'Global temperature maps capture land and ocean heat changes, offering insights into climate trends and extreme weather.',
  ...
  {
    id: 'terra25/data-insights/aerosol',
    name: 'Pollution',
    icon: Cloud,
    color: '#64B5F6',
    tagline: 'Air quality & particle tracking',
    description: 'AI-driven sky mapping measures cloud coverage and movement to improve weather predictions and climate research.',
  ...
  {
    id: 'terra25/data-insights/radiation',
    name: 'Topology',
    icon: Sun,
    color: '#FFB300',
...
export default function StationNavigator() {
  ...
  return (
    <div className="font-custom3 h-screen w-screen overflow-hidden relative flex flex-col bg-black">
        ...
        <div className="flex-none h-[10vh] flex items-center justify-center px-8">
          <div className="flex items-center justify-between w-full max-w-4xl">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-lg transition-all duration-300 border backdrop-blur-sm ${activeStation === 0
            ...
            <div className="text-center">
              <div
                className="text-5xl font-bold tracking-wider mb-1 transition-all duration-500"
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-lg transition-all duration-300 border backdrop-blur-sm ${activeStation === stations.length - 1
                ? 'border-gray-700/50 text-gray-600 cursor-not-allowed bg-gray-900/20'
                : 'border-cyan-500/40 text-cyan-300 hover:bg-cyan-500/10 hover:border-cyan-400 bg-cyan-900/20'
                }`}
            >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      {/* Main orb */}
                      <div
                        className={`relative w-20 h-20 rounded-full transition-all duration-500 transform ${isActive ? 'scale-125' : isHovered ? 'scale-110' : 'scale-100'
                          }`}
                        style={{
                          background: isActive
                    ...
                    {/* Label */}
                    <div
                      className={`mt-4 text-center transition-all duration-500 ${isActive ? 'opacity-100' : 'opacity-70'
                        }`}
                    >
                      <div
        ...
        <div className="flex-none h-[10vh] flex items-center justify-center gap-2 px-8">
          {stations.map((station, index) => (
            <button
              key={station.id}
              onClick={() => handleStationClick(index)}
              className={`w-3 h-3 rounded-full transition-all duration-500 ${activeStation === index ? 'w-12' : 'hover:scale-125'
                }`}
              style={{
