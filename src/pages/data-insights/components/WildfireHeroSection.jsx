    ...
    >
      ...
      >
          ...
          <div ref={titleRef} className="space-y-8">
            <div className="overflow-hidden">
              <div className="title-line">
                <span className="text-amber-300/90 mt-10 text-sm tracking-[0.3em] uppercase font-light block mb-4 drop-shadow-2xl">
        ...
        <motion.div
          ...
          >
            <span className="text-xs mt-10 text-amber-200/70 tracking-[0.3em] uppercase drop-shadow-2xl font-light">
              Scroll to Explore
            </span>
