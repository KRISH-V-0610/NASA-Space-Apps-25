  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          <span className="text-xs mt-12  text-cyan-200/70 tracking-[0.3em] uppercase drop-shadow-2xl font-light">
            Scroll to Explore
          </span>
...
const SurfaceTempPage = () => {
  ...
  return (
    <div className="bg-slate-950 w-full">    {/* Rest of your content */}
